...
|**orderId** | **String** | The pay-in order ID. |  [optional] |
...
|**customPayerId** | **String** | A unique identifier assigned by the developer to track and identify individual payers in their system. |  [optional] |
