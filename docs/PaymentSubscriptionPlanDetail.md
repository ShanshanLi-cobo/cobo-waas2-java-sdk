...
|**chargeAmount** | **String** | The subscription plan crypto amount with input token_id.  |  [optional] |
|**contractAddress** | **String** | The subscription contract address in cobo. |  [optional] |
