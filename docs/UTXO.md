...
|**isChange** | **Boolean** | Whether the UTXO is a change output of a transaction. |  [optional] |
|**chainId** | **String** | The chain ID, which is the unique identifier of a blockchain. |  [optional] |
