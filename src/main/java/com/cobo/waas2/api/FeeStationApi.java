...
public class FeeStationApi {
    ...
    /**
     * Build call for listFeeStationFiatTransactions
     * @param transactionIds A list of transaction IDs, separated by comma. (optional)
     * @param transactionType The type of the fiat transaction. Possible values include:   - &#x60;deposit&#x60;: A deposit transaction.   - &#x60;transfer&#x60;: A transfer transaction.  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The information about the fiat transactions. </td><td>  -  </td></tr>
        <tr><td> 4XX </td><td> Bad request. Your request contains malformed syntax or invalid parameters. </td><td>  -  </td></tr>
        <tr><td> 5XX </td><td> Internal server error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listFeeStationFiatTransactionsCall(String transactionIds, FeeStationFiatTransactionType transactionType, Long minCreatedTimestamp, Long maxCreatedTimestamp, String before, String after, Integer limit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/fee_station/fiat_transactions";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listFeeStationFiatTransactionsValidateBeforeCall(String transactionIds, FeeStationFiatTransactionType transactionType, Long minCreatedTimestamp, Long maxCreatedTimestamp, String before, String after, Integer limit, final ApiCallback _callback) throws ApiException {
        return listFeeStationFiatTransactionsCall(transactionIds, transactionType, minCreatedTimestamp, maxCreatedTimestamp, before, after, limit, _callback);
     ...
     */
    public ListFeeStationFiatTransactions200Response listFeeStationFiatTransactions(String transactionIds, FeeStationFiatTransactionType transactionType, Long minCreatedTimestamp, Long maxCreatedTimestamp, String before, String after, Integer limit) throws ApiException {
        ApiResponse<ListFeeStationFiatTransactions200Response> localVarResp = listFeeStationFiatTransactionsWithHttpInfo(transactionIds, transactionType, minCreatedTimestamp, maxCreatedTimestamp, before, after, limit);
        return localVarResp.getData();
    }
     ...
     * @param after A cursor indicating the position after the current page. This value is generated by Cobo and returned in the response. You do not need to provide it on the first request. When paginating forward (to the next page), you should pass the after value returned from the last response.  (optional)
     * @param limit The maximum number of objects to return. For most operations, the value range is [1, 50]. (optional, default to 10)
     * @return ApiResponse&lt;ListFeeStationFiatTransactions200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListFeeStationFiatTransactions200Response> listFeeStationFiatTransactionsWithHttpInfo(String transactionIds, FeeStationFiatTransactionType transactionType, Long minCreatedTimestamp, Long maxCreatedTimestamp, String before, String after, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = listFeeStationFiatTransactionsValidateBeforeCall(transactionIds, transactionType, minCreatedTimestamp, maxCreatedTimestamp, before, after, limit, null);
        Type localVarReturnType = new TypeToken<ListFeeStationFiatTransactions200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Fee Station fiat transactions (asynchronously)
     * This operation retrieves all Fee Station fiat transactions under your organization.  You can filter the results by request IDs, transaction IDs, transaction type, and created timestamp. You can also paginate your query results. 
     * @param transactionIds A list of transaction IDs, separated by comma. (optional)
     * @param transactionType The type of the fiat transaction. Possible values include:   - &#x60;deposit&#x60;: A deposit transaction.   - &#x60;transfer&#x60;: A transfer transaction.  (optional)
     * @param minCreatedTimestamp The time when the transaction was created, in Unix timestamp format, measured in milliseconds. You can use this parameter to filter transactions created on or after the specified time.  If you specify &#x60;min_created_timestamp&#x60; without specifying &#x60;max_created_timestamp&#x60;, &#x60;max_created_timestamp&#x60; is automatically set to &#x60;min_created_timestamp&#x60; + 90 days. If you specify both, the time range cannot exceed 90 days.  If not provided, the default value is 90 days before the current time. This default value is subject to change.  (optional)
     ...
     */
    public okhttp3.Call listFeeStationFiatTransactionsAsync(String transactionIds, FeeStationFiatTransactionType transactionType, Long minCreatedTimestamp, Long maxCreatedTimestamp, String before, String after, Integer limit, final ApiCallback<ListFeeStationFiatTransactions200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listFeeStationFiatTransactionsValidateBeforeCall(transactionIds, transactionType, minCreatedTimestamp, maxCreatedTimestamp, before, after, limit, _callback);
        Type localVarReturnType = new TypeToken<ListFeeStationFiatTransactions200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
