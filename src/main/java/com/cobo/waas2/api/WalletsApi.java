...
public class WalletsApi {
     ...
     */
    public okhttp3.Call checkAddressChainsValidityCall(String address, String chainIds, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/wallets/check_address_chains_validity";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call checkAddressChainsValidityValidateBeforeCall(String address, String chainIds, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'address' is set
        if (address == null) {
            throw new ApiException("Missing the required parameter 'address' when calling checkAddressChainsValidity(Async)");
        }

        // verify the required parameter 'chainIds' is set
        if (chainIds == null) {
            throw new ApiException("Missing the required parameter 'chainIds' when calling checkAddressChainsValidity(Async)");
        }

        return checkAddressChainsValidityCall(address, chainIds, _callback);
     ...
     */
    public List<CheckAddressChainsValidity200ResponseInner> checkAddressChainsValidity(String address, String chainIds) throws ApiException {
        ApiResponse<List<CheckAddressChainsValidity200ResponseInner>> localVarResp = checkAddressChainsValidityWithHttpInfo(address, chainIds);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<CheckAddressChainsValidity200ResponseInner>> checkAddressChainsValidityWithHttpInfo(String address, String chainIds) throws ApiException {
        okhttp3.Call localVarCall = checkAddressChainsValidityValidateBeforeCall(address, chainIds, null);
        Type localVarReturnType = new TypeToken<List<CheckAddressChainsValidity200ResponseInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call checkAddressChainsValidityAsync(String address, String chainIds, final ApiCallback<List<CheckAddressChainsValidity200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = checkAddressChainsValidityValidateBeforeCall(address, chainIds, _callback);
        Type localVarReturnType = new TypeToken<List<CheckAddressChainsValidity200ResponseInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param chainId The chain ID, which is the unique identifier of a blockchain. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Build call for listTransactionUtxos
     * @param walletId The wallet ID. (required)
     * @param chainId The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains). (required)
     * @param txHash The transaction hash to filter UTXOs by. (required)
     ...
     */
    public okhttp3.Call listTransactionUtxosCall(UUID walletId, String chainId, String txHash, Boolean isChange, Integer voutN, String tokenId, String address, Integer limit, String before, String after, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/wallets/{wallet_id}/transaction_utxos"
            .replace("{" + "wallet_id" + "}", localVarApiClient.escapeString(walletId.toString()));
        ...
        if (isChange != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("is_change", isChange));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listTransactionUtxosValidateBeforeCall(UUID walletId, String chainId, String txHash, Boolean isChange, Integer voutN, String tokenId, String address, Integer limit, String before, String after, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'walletId' is set
        if (walletId == null) {
            throw new ApiException("Missing the required parameter 'walletId' when calling listTransactionUtxos(Async)");
        }

        // verify the required parameter 'chainId' is set
        if (chainId == null) {
            throw new ApiException("Missing the required parameter 'chainId' when calling listTransactionUtxos(Async)");
        }

        // verify the required parameter 'txHash' is set
        if (txHash == null) {
            throw new ApiException("Missing the required parameter 'txHash' when calling listTransactionUtxos(Async)");
        }

        return listTransactionUtxosCall(walletId, chainId, txHash, isChange, voutN, tokenId, address, limit, before, after, _callback);
     ...
     */
    public ListUtxos200Response listTransactionUtxos(UUID walletId, String chainId, String txHash, Boolean isChange, Integer voutN, String tokenId, String address, Integer limit, String before, String after) throws ApiException {
        ApiResponse<ListUtxos200Response> localVarResp = listTransactionUtxosWithHttpInfo(walletId, chainId, txHash, isChange, voutN, tokenId, address, limit, before, after);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListUtxos200Response> listTransactionUtxosWithHttpInfo(UUID walletId, String chainId, String txHash, Boolean isChange, Integer voutN, String tokenId, String address, Integer limit, String before, String after) throws ApiException {
        okhttp3.Call localVarCall = listTransactionUtxosValidateBeforeCall(walletId, chainId, txHash, isChange, voutN, tokenId, address, limit, before, after, null);
        Type localVarReturnType = new TypeToken<ListUtxos200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List transaction UTXOs (asynchronously)
     * The operation retrieves a list of UTXOs for a specified transaction of a wallet. You must specify the wallet, chain, and transaction hash.  &lt;Note&gt;This operation is applicable to MPC and Custodial Web3 Wallets.&lt;/Note&gt; 
     * @param walletId The wallet ID. (required)
     * @param chainId The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains). (required)
     * @param txHash The transaction hash to filter UTXOs by. (required)
     ...
     */
    public okhttp3.Call listTransactionUtxosAsync(UUID walletId, String chainId, String txHash, Boolean isChange, Integer voutN, String tokenId, String address, Integer limit, String before, String after, final ApiCallback<ListUtxos200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTransactionUtxosValidateBeforeCall(walletId, chainId, txHash, isChange, voutN, tokenId, address, limit, before, after, _callback);
        Type localVarReturnType = new TypeToken<ListUtxos200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
