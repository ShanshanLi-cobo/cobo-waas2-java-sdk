...
import com.cobo.waas2.auth.Authentication;
import com.cobo.waas2.auth.AuthenticationInterceptor;
import com.cobo.waas2.auth.OAuth;
import com.cobo.waas2.auth.RetryingOAuth;
import com.cobo.waas2.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://api.dev.cobo.com/v2";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://auth.cobo.com/oauth/token";
    ...
    private void init() {
        ...
        setUserAgent("cobo-waas2-java-sdk/1.25.0");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.dev.cobo.com/v2
     ...
     * @return a {@link com.cobo.waas2.ApiClient} object
     */
     ...
     * @throws com.cobo.waas2.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.cobo.waas2.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.cobo.waas2.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.cobo.waas2.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.cobo.waas2.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.cobo.waas2.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.cobo.waas2.ApiException If fails to update the parameters
     */
     ...
     * @throws com.cobo.waas2.ApiException If fail to serialize the request body object into a string
     */
    ...
    public ApiClient setEnv(Integer env) {
        serverIndex = env;
        return this;
    }
}
