...
public class OrgInfo {
  ...
  **/
  ...
  public OrgInfo createdTimestamp(Long createdTimestamp) {
  ...
  **/
   ...
   * @return the OrgInfo instance itself
   */
  public OrgInfo putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrgInfo>() {
           ...
           public OrgInfo read(JsonReader in) throws IOException {
             ...
             OrgInfo instance = thisAdapter.fromJsonTree(jsonObj);
