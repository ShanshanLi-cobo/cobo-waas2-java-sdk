...
public class PaymentPayoutItem {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(payoutItemId, payoutId, tokenId, chainId, amount, status, sourceAccount, transactions, createdTimestamp, updatedTimestamp, cryptoAddressId, cryptoAddress, commissionFee, bridgingFee, additionalProperties);
  }
