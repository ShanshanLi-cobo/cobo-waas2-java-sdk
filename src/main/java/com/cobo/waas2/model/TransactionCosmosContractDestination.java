...
public class TransactionCosmosContractDestination {
  ...
  public TransactionCosmosContractDestination destinationType(TransactionDestinationType destinationType) {
  ...
  **/
  ...
  public TransactionCosmosContractDestination cosmosMessages(List<TransactionCosmosMessage> cosmosMessages) {
    this.cosmosMessages = cosmosMessages;
    return this;
  }

  public TransactionCosmosContractDestination addCosmosMessagesItem(TransactionCosmosMessage cosmosMessagesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<TransactionCosmosMessage> getCosmosMessages() {
    return cosmosMessages;
  }
  ...
  **/
   ...
   * @return the TransactionCosmosContractDestination instance itself
   */
  public TransactionCosmosContractDestination putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionCosmosContractDestination
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionCosmosContractDestination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionCosmosContractDestination is not found in the empty JSON string", TransactionCosmosContractDestination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionCosmosContractDestination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionCosmosContractDestination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionCosmosContractDestination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionCosmosContractDestination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionCosmosContractDestination.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionCosmosContractDestination>() {
           @Override
           public void write(JsonWriter out, TransactionCosmosContractDestination value) throws IOException {
           ...
           @Override
           public TransactionCosmosContractDestination read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TransactionCosmosContractDestination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionCosmosContractDestination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionCosmosContractDestination
  * @throws IOException if the JSON string is invalid with respect to TransactionCosmosContractDestination
  */
  public static TransactionCosmosContractDestination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionCosmosContractDestination.class);
  }

 /**
  * Convert an instance of TransactionCosmosContractDestination to an JSON string
  *
  * @return JSON string
  */
