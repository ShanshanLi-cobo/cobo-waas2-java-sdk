...
public class CreateBatchAllocationRequest {
  ...
  public CreateBatchAllocationRequest requestId(String requestId) {
  ...
  **/
  ...
  public CreateBatchAllocationRequest sourceType(PaymentSourceType sourceType) {
  ...
  **/
   ...
   * @return the CreateBatchAllocationRequest instance itself
   */
  public CreateBatchAllocationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, createBatchAllocationRequest.requestId) &&
        Objects.equals(this.sourceType, createBatchAllocationRequest.sourceType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, sourceType, allocationRequests, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateBatchAllocationRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBatchAllocationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBatchAllocationRequest is not found in the empty JSON string", CreateBatchAllocationRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateBatchAllocationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBatchAllocationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBatchAllocationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBatchAllocationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBatchAllocationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBatchAllocationRequest>() {
           @Override
           public void write(JsonWriter out, CreateBatchAllocationRequest value) throws IOException {
           ...
           @Override
           public CreateBatchAllocationRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateBatchAllocationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateBatchAllocationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateBatchAllocationRequest
  * @throws IOException if the JSON string is invalid with respect to CreateBatchAllocationRequest
  */
  public static CreateBatchAllocationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBatchAllocationRequest.class);
  }

 /**
  * Convert an instance of CreateBatchAllocationRequest to an JSON string
  *
  * @return JSON string
  */
