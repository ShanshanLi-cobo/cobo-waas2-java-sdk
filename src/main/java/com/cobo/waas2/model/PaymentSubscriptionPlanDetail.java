...
public class PaymentSubscriptionPlanDetail {
  ...
  **/
  ...
  public PaymentSubscriptionPlanDetail developerPlanId(String developerPlanId) {
  ...
  **/
  ...
  public PaymentSubscriptionPlanDetail periodType(PaymentSubscriptionPeriodType periodType) {
  ...
  **/
  ...
  public PaymentSubscriptionPlanDetail periods(Integer periods) {
  ...
  **/
  ...
  public PaymentSubscriptionPlanDetail interval(Integer interval) {
  ...
  **/
  ...
  public PaymentSubscriptionPlanDetail tokenId(String tokenId) {
  ...
  **/
  ...
  public PaymentSubscriptionPlanDetail currency(String currency) {
  ...
  **/
   ...
   * @return the PaymentSubscriptionPlanDetail instance itself
   */
  public PaymentSubscriptionPlanDetail putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PaymentSubscriptionPlanDetail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentSubscriptionPlanDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentSubscriptionPlanDetail is not found in the empty JSON string", PaymentSubscriptionPlanDetail.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentSubscriptionPlanDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentSubscriptionPlanDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentSubscriptionPlanDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentSubscriptionPlanDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentSubscriptionPlanDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentSubscriptionPlanDetail>() {
           @Override
           public void write(JsonWriter out, PaymentSubscriptionPlanDetail value) throws IOException {
           ...
           @Override
           public PaymentSubscriptionPlanDetail read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PaymentSubscriptionPlanDetail instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentSubscriptionPlanDetail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentSubscriptionPlanDetail
  * @throws IOException if the JSON string is invalid with respect to PaymentSubscriptionPlanDetail
  */
  public static PaymentSubscriptionPlanDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentSubscriptionPlanDetail.class);
  }

 /**
  * Convert an instance of PaymentSubscriptionPlanDetail to an JSON string
  *
  * @return JSON string
  */
