...
public class PaymentBaseSubscriptionActionData {
  ...
  **/
  ...
  public PaymentBaseSubscriptionActionData subscriptionId(String subscriptionId) {
  ...
  **/
  ...
  public PaymentBaseSubscriptionActionData signature(String signature) {
  ...
  **/
   ...
   * @return the PaymentBaseSubscriptionActionData instance itself
   */
  public PaymentBaseSubscriptionActionData putAdditionalProperty(String key, Object value) {
  ...
  public String toString() {
    ...
    sb.append("class PaymentBaseSubscriptionActionData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PaymentBaseSubscriptionActionData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentBaseSubscriptionActionData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentBaseSubscriptionActionData is not found in the empty JSON string", PaymentBaseSubscriptionActionData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentBaseSubscriptionActionData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentBaseSubscriptionActionData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentBaseSubscriptionActionData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentBaseSubscriptionActionData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentBaseSubscriptionActionData.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentBaseSubscriptionActionData>() {
           @Override
           public void write(JsonWriter out, PaymentBaseSubscriptionActionData value) throws IOException {
           ...
           @Override
           public PaymentBaseSubscriptionActionData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PaymentBaseSubscriptionActionData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentBaseSubscriptionActionData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentBaseSubscriptionActionData
  * @throws IOException if the JSON string is invalid with respect to PaymentBaseSubscriptionActionData
  */
  public static PaymentBaseSubscriptionActionData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentBaseSubscriptionActionData.class);
  }

 /**
  * Convert an instance of PaymentBaseSubscriptionActionData to an JSON string
  *
  * @return JSON string
  */
