...
public class RoleDetail {
  ...
  public RoleDetail result(ApprovalTransactionResult result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public RoleDetail userDetails(List<ApprovalUserDetail> userDetails) {
    this.userDetails = userDetails;
    return this;
  }

  public RoleDetail addUserDetailsItem(ApprovalUserDetail userDetailsItem) {
  ...
  **/
   ...
   * @return the RoleDetail instance itself
   */
  public RoleDetail putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RoleDetail>() {
           ...
           public RoleDetail read(JsonReader in) throws IOException {
             ...
             RoleDetail instance = thisAdapter.fromJsonTree(jsonObj);
