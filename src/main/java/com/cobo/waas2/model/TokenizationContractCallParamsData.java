...
public class TokenizationContractCallParamsData extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TokenizationContractCallParamsData.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TokenizationContractCallParamsData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TokenizationContractCallParamsData' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TokenizationContractCallParamsData>() {
                @Override
                public void write(JsonWriter out, TokenizationContractCallParamsData value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `TokenizationEvmContractCallParams`
                    if (value.getActualInstance() instanceof TokenizationEvmContractCallParams) {
                        JsonElement element = adapterTokenizationEvmContractCallParams.toJsonTree((TokenizationEvmContractCallParams)value.getActualInstance());
                ...
                @Override
                public TokenizationContractCallParamsData read(JsonReader in) throws IOException {
                    ...
                    TokenizationContractCallParamsData newTokenizationContractCallParamsData = new TokenizationContractCallParamsData();
                    if (jsonObject.get("type") == null) {
                        log.log(Level.WARNING, "Failed to lookup discriminator value for TokenizationContractCallParamsData as `type` was not found in the payload or the payload is empty.");
                    } else  {
                    ...
                    // deserialize TokenizationEvmContractCallParams
                    try {
                        // validate the JSON object to see if any exception is thrown
                        TokenizationEvmContractCallParams.validateJsonElement(jsonElement);
                        actualAdapter = adapterTokenizationEvmContractCallParams;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'TokenizationEvmContractCallParams'");
                    } catch (Exception e) {
                    ...
                    if (match == 1) {
                        TokenizationContractCallParamsData ret = new TokenizationContractCallParamsData();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for TokenizationContractCallParamsData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TokenizationContractCallParamsData() {
        super("oneOf", Boolean.FALSE);
    }

    public TokenizationContractCallParamsData(TokenizationEvmContractCallParams o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TokenizationContractCallParamsData.schemas;
    }
    ...
    /**
     * Get the actual instance of `TokenizationEvmContractCallParams`. If the actual instance is not `TokenizationEvmContractCallParams`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `TokenizationEvmContractCallParams`
     * @throws ClassCastException if the instance is not `TokenizationEvmContractCallParams`
     */
     ...
     * @throws IOException if the JSON Element is invalid with respect to TokenizationContractCallParamsData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate oneOf schemas one by one
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with TokenizationEvmContractCallParams
        try {
            TokenizationEvmContractCallParams.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
    ...
    /**
     * Create an instance of TokenizationContractCallParamsData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TokenizationContractCallParamsData
     * @throws IOException if the JSON string is invalid with respect to TokenizationContractCallParamsData
     */
    public static TokenizationContractCallParamsData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TokenizationContractCallParamsData.class);
    }

    /**
     * Convert an instance of TokenizationContractCallParamsData to an JSON string
     *
     * @return JSON string
     */
