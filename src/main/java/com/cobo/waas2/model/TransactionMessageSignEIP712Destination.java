...
public class TransactionMessageSignEIP712Destination {
  ...
  public TransactionMessageSignEIP712Destination destinationType(TransactionDestinationType destinationType) {
  ...
  **/
  ...
  public TransactionMessageSignEIP712Destination structuredData(Map<String, Object> structuredData) {
    this.structuredData = structuredData;
    return this;
  }

  public TransactionMessageSignEIP712Destination putStructuredDataItem(String key, Object structuredDataItem) {
  ...
  **/
   ...
   * @return the TransactionMessageSignEIP712Destination instance itself
   */
  public TransactionMessageSignEIP712Destination putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionMessageSignEIP712Destination
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionMessageSignEIP712Destination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionMessageSignEIP712Destination is not found in the empty JSON string", TransactionMessageSignEIP712Destination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionMessageSignEIP712Destination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionMessageSignEIP712Destination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionMessageSignEIP712Destination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionMessageSignEIP712Destination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionMessageSignEIP712Destination.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionMessageSignEIP712Destination>() {
           @Override
           public void write(JsonWriter out, TransactionMessageSignEIP712Destination value) throws IOException {
           ...
           @Override
           public TransactionMessageSignEIP712Destination read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TransactionMessageSignEIP712Destination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionMessageSignEIP712Destination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionMessageSignEIP712Destination
  * @throws IOException if the JSON string is invalid with respect to TransactionMessageSignEIP712Destination
  */
  public static TransactionMessageSignEIP712Destination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionMessageSignEIP712Destination.class);
  }

 /**
  * Convert an instance of TransactionMessageSignEIP712Destination to an JSON string
  *
  * @return JSON string
  */
