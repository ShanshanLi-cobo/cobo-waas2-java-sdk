...
public class CustodialWeb3TransferSource {
  ...
  public CustodialWeb3TransferSource() {
  }

  public CustodialWeb3TransferSource sourceType(WalletSubtype sourceType) {
  ...
  **/
  ...
  public CustodialWeb3TransferSource walletId(UUID walletId) {
  ...
  **/
  ...
  public CustodialWeb3TransferSource address(String address) {
  ...
  **/
  ...
  public CustodialWeb3TransferSource includedUtxos(List<TransactionUtxo> includedUtxos) {
    this.includedUtxos = includedUtxos;
    return this;
  }

  public CustodialWeb3TransferSource addIncludedUtxosItem(TransactionUtxo includedUtxosItem) {
  ...
  **/
  ...
  public CustodialWeb3TransferSource excludedUtxos(List<TransactionUtxo> excludedUtxos) {
    this.excludedUtxos = excludedUtxos;
    return this;
  }

  public CustodialWeb3TransferSource addExcludedUtxosItem(TransactionUtxo excludedUtxosItem) {
  ...
  **/
   ...
   * @return the CustodialWeb3TransferSource instance itself
   */
  public CustodialWeb3TransferSource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustodialWeb3TransferSource custodialWeb3TransferSource = (CustodialWeb3TransferSource) o;
    return Objects.equals(this.sourceType, custodialWeb3TransferSource.sourceType) &&
        Objects.equals(this.walletId, custodialWeb3TransferSource.walletId) &&
        Objects.equals(this.address, custodialWeb3TransferSource.address) &&
        Objects.equals(this.includedUtxos, custodialWeb3TransferSource.includedUtxos) &&
        Objects.equals(this.excludedUtxos, custodialWeb3TransferSource.excludedUtxos)&&
        Objects.equals(this.additionalProperties, custodialWeb3TransferSource.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustodialWeb3TransferSource {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustodialWeb3TransferSource
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustodialWeb3TransferSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustodialWeb3TransferSource is not found in the empty JSON string", CustodialWeb3TransferSource.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustodialWeb3TransferSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustodialWeb3TransferSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustodialWeb3TransferSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustodialWeb3TransferSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustodialWeb3TransferSource.class));

       return (TypeAdapter<T>) new TypeAdapter<CustodialWeb3TransferSource>() {
           @Override
           public void write(JsonWriter out, CustodialWeb3TransferSource value) throws IOException {
           ...
           @Override
           public CustodialWeb3TransferSource read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CustodialWeb3TransferSource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CustodialWeb3TransferSource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustodialWeb3TransferSource
  * @throws IOException if the JSON string is invalid with respect to CustodialWeb3TransferSource
  */
  public static CustodialWeb3TransferSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustodialWeb3TransferSource.class);
  }

 /**
  * Convert an instance of CustodialWeb3TransferSource to an JSON string
  *
  * @return JSON string
  */
