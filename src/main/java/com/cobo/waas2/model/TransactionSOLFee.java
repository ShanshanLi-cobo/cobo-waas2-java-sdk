...
public class TransactionSOLFee {
  ...
  public TransactionSOLFee() {
  }

  public TransactionSOLFee baseFee(String baseFee) {
  ...
  **/
  ...
  public TransactionSOLFee rentAmount(String rentAmount) {
  ...
  **/
  ...
  public TransactionSOLFee computeUnitPrice(String computeUnitPrice) {
  ...
  **/
  ...
  public TransactionSOLFee computeUnitLimit(String computeUnitLimit) {
  ...
  **/
  ...
  public TransactionSOLFee feeType(FeeType feeType) {
  ...
  **/
  ...
  public TransactionSOLFee tokenId(String tokenId) {
  ...
  **/
  ...
  public TransactionSOLFee feeUsed(String feeUsed) {
  ...
  **/
  ...
  public TransactionSOLFee estimatedFeeUsed(String estimatedFeeUsed) {
  ...
  **/
   ...
   * @return the TransactionSOLFee instance itself
   */
  public TransactionSOLFee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionSOLFee transactionSOLFee = (TransactionSOLFee) o;
    return Objects.equals(this.baseFee, transactionSOLFee.baseFee) &&
        Objects.equals(this.rentAmount, transactionSOLFee.rentAmount) &&
        Objects.equals(this.computeUnitPrice, transactionSOLFee.computeUnitPrice) &&
        Objects.equals(this.computeUnitLimit, transactionSOLFee.computeUnitLimit) &&
        Objects.equals(this.feeType, transactionSOLFee.feeType) &&
        Objects.equals(this.tokenId, transactionSOLFee.tokenId) &&
        Objects.equals(this.feeUsed, transactionSOLFee.feeUsed) &&
        Objects.equals(this.estimatedFeeUsed, transactionSOLFee.estimatedFeeUsed)&&
        Objects.equals(this.additionalProperties, transactionSOLFee.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(baseFee, rentAmount, computeUnitPrice, computeUnitLimit, feeType, tokenId, feeUsed, estimatedFeeUsed, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TransactionSOLFee {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionSOLFee
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionSOLFee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionSOLFee is not found in the empty JSON string", TransactionSOLFee.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionSOLFee.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionSOLFee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionSOLFee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionSOLFee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionSOLFee.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionSOLFee>() {
           @Override
           public void write(JsonWriter out, TransactionSOLFee value) throws IOException {
           ...
           @Override
           public TransactionSOLFee read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TransactionSOLFee instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionSOLFee given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionSOLFee
  * @throws IOException if the JSON string is invalid with respect to TransactionSOLFee
  */
  public static TransactionSOLFee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionSOLFee.class);
  }

 /**
  * Convert an instance of TransactionSOLFee to an JSON string
  *
  * @return JSON string
  */
