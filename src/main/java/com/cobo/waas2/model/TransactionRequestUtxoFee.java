...
public class TransactionRequestUtxoFee {
  ...
  public TransactionRequestUtxoFee() {
  }

  public TransactionRequestUtxoFee feeRate(String feeRate) {
  ...
  **/
  ...
  public TransactionRequestUtxoFee tokenId(String tokenId) {
  ...
  **/
  ...
  public TransactionRequestUtxoFee maxFeeAmount(String maxFeeAmount) {
  ...
  **/
   ...
   * @return the TransactionRequestUtxoFee instance itself
   */
  public TransactionRequestUtxoFee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.feeRate, transactionRequestUtxoFee.feeRate) &&
        ...
        Objects.equals(this.additionalProperties, transactionRequestUtxoFee.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionRequestUtxoFee
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionRequestUtxoFee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionRequestUtxoFee is not found in the empty JSON string", TransactionRequestUtxoFee.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionRequestUtxoFee.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionRequestUtxoFee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionRequestUtxoFee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionRequestUtxoFee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionRequestUtxoFee.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionRequestUtxoFee>() {
           @Override
           public void write(JsonWriter out, TransactionRequestUtxoFee value) throws IOException {
           ...
           @Override
           public TransactionRequestUtxoFee read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TransactionRequestUtxoFee instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionRequestUtxoFee given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionRequestUtxoFee
  * @throws IOException if the JSON string is invalid with respect to TransactionRequestUtxoFee
  */
  public static TransactionRequestUtxoFee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionRequestUtxoFee.class);
  }

 /**
  * Convert an instance of TransactionRequestUtxoFee to an JSON string
  *
  * @return JSON string
  */
