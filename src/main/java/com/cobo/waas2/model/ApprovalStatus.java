...
public enum ApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<ApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ApprovalStatus read(final JsonReader jsonReader) throws IOException {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    ApprovalStatus.fromValue(value);
  }
}
