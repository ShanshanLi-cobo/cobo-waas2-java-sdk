...
public class ChainsEventData {
  ...
  public ChainsEventData dataType(DataTypeEnum dataType) {
  ...
  **/
  ...
  public ChainsEventData chains(List<ChainInfo> chains) {
    this.chains = chains;
    return this;
  }

  public ChainsEventData addChainsItem(ChainInfo chainsItem) {
    if (this.chains == null) {
  ...
  **/
   ...
   * @return the ChainsEventData instance itself
   */
  public ChainsEventData putAdditionalProperty(String key, Object value) {
  ...
  static {
    ...
    openapiRequiredFields.add("chains");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ChainsEventData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChainsEventData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChainsEventData is not found in the empty JSON string", ChainsEventData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChainsEventData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChainsEventData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChainsEventData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChainsEventData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChainsEventData.class));

       return (TypeAdapter<T>) new TypeAdapter<ChainsEventData>() {
           @Override
           public void write(JsonWriter out, ChainsEventData value) throws IOException {
           ...
           @Override
           public ChainsEventData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ChainsEventData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChainsEventData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChainsEventData
  * @throws IOException if the JSON string is invalid with respect to ChainsEventData
  */
  public static ChainsEventData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChainsEventData.class);
  }

 /**
  * Convert an instance of ChainsEventData to an JSON string
  *
  * @return JSON string
  */
