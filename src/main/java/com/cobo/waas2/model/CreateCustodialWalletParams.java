...
public class CreateCustodialWalletParams {
  ...
  public CreateCustodialWalletParams name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CreateCustodialWalletParams walletType(WalletType walletType) {
  ...
  **/
  ...
  public CreateCustodialWalletParams walletSubtype(WalletSubtype walletSubtype) {
  ...
  **/
   ...
   * @return the CreateCustodialWalletParams instance itself
   */
  public CreateCustodialWalletParams putAdditionalProperty(String key, Object value) {
  ...
  public String toString() {
    ...
    sb.append("class CreateCustodialWalletParams {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateCustodialWalletParams
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCustodialWalletParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCustodialWalletParams is not found in the empty JSON string", CreateCustodialWalletParams.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCustodialWalletParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCustodialWalletParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCustodialWalletParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCustodialWalletParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCustodialWalletParams.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCustodialWalletParams>() {
           @Override
           public void write(JsonWriter out, CreateCustodialWalletParams value) throws IOException {
           ...
           @Override
           public CreateCustodialWalletParams read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateCustodialWalletParams instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateCustodialWalletParams given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCustodialWalletParams
  * @throws IOException if the JSON string is invalid with respect to CreateCustodialWalletParams
  */
  public static CreateCustodialWalletParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCustodialWalletParams.class);
  }

 /**
  * Convert an instance of CreateCustodialWalletParams to an JSON string
  *
  * @return JSON string
  */
