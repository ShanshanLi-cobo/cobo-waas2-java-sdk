...
public class PayoutEstimatedFee extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PayoutEstimatedFee.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PayoutEstimatedFee.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PayoutEstimatedFee' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PayoutEstimatedFee>() {
                @Override
                public void write(JsonWriter out, PayoutEstimatedFee value) throws IOException {
                ...
                @Override
                public PayoutEstimatedFee read(JsonReader in) throws IOException {
                    ...
                    PayoutEstimatedFee newPayoutEstimatedFee = new PayoutEstimatedFee();
                    if (jsonObject.get("fee_type") == null) {
                        log.log(Level.WARNING, "Failed to lookup discriminator value for PayoutEstimatedFee as `fee_type` was not found in the payload or the payload is empty.");
                    } else  {
                        ...
                        switch (jsonObject.get("fee_type").getAsString()) {
                            case "EVM_EIP_1559":
                                ...
                                newPayoutEstimatedFee.setActualInstance(deserialized);
                                return newPayoutEstimatedFee;
                            case "EVM_Legacy":
                            ...
                            case "EstimatedUtxoFee":
                                ...
                                return newPayoutEstimatedFee;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for PayoutEstimatedFee. Possible values: EVM_EIP_1559 EVM_Legacy Fixed UTXO EstimatedEvmEip1559Fee EstimatedEvmLegacyFee EstimatedFixedFee EstimatedUtxoFee", jsonObject.get("fee_type").getAsString()));
                        }
                    }
                    ...
                    if (match == 1) {
                        PayoutEstimatedFee ret = new PayoutEstimatedFee();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PayoutEstimatedFee: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PayoutEstimatedFee() {
        super("oneOf", Boolean.FALSE);
    }

    public PayoutEstimatedFee(EstimatedEvmEip1559Fee o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PayoutEstimatedFee(EstimatedEvmLegacyFee o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PayoutEstimatedFee(EstimatedFixedFee o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PayoutEstimatedFee(EstimatedUtxoFee o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PayoutEstimatedFee.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PayoutEstimatedFee
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            // throw new IOException(String.format("The JSON string is invalid for PayoutEstimatedFee with oneOf schemas: EstimatedEvmEip1559Fee, EstimatedEvmLegacyFee, EstimatedFixedFee, EstimatedUtxoFee. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of PayoutEstimatedFee given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PayoutEstimatedFee
     * @throws IOException if the JSON string is invalid with respect to PayoutEstimatedFee
     */
    public static PayoutEstimatedFee fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PayoutEstimatedFee.class);
    }

    /**
     * Convert an instance of PayoutEstimatedFee to an JSON string
     *
     * @return JSON string
     */
