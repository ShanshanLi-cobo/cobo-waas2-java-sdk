...
public class PaymentExtendPeriodSubscriptionActionData {
  ...
  **/
  ...
  public PaymentExtendPeriodSubscriptionActionData subscriptionId(String subscriptionId) {
  ...
  **/
  ...
  public PaymentExtendPeriodSubscriptionActionData signature(String signature) {
  ...
  **/
   ...
   * @return the PaymentExtendPeriodSubscriptionActionData instance itself
   */
  public PaymentExtendPeriodSubscriptionActionData putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PaymentExtendPeriodSubscriptionActionData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentExtendPeriodSubscriptionActionData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentExtendPeriodSubscriptionActionData is not found in the empty JSON string", PaymentExtendPeriodSubscriptionActionData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentExtendPeriodSubscriptionActionData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentExtendPeriodSubscriptionActionData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentExtendPeriodSubscriptionActionData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentExtendPeriodSubscriptionActionData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentExtendPeriodSubscriptionActionData.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentExtendPeriodSubscriptionActionData>() {
           @Override
           public void write(JsonWriter out, PaymentExtendPeriodSubscriptionActionData value) throws IOException {
           ...
           @Override
           public PaymentExtendPeriodSubscriptionActionData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PaymentExtendPeriodSubscriptionActionData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentExtendPeriodSubscriptionActionData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentExtendPeriodSubscriptionActionData
  * @throws IOException if the JSON string is invalid with respect to PaymentExtendPeriodSubscriptionActionData
  */
  public static PaymentExtendPeriodSubscriptionActionData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentExtendPeriodSubscriptionActionData.class);
  }

 /**
  * Convert an instance of PaymentExtendPeriodSubscriptionActionData to an JSON string
  *
  * @return JSON string
  */
