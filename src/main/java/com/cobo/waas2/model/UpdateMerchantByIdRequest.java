...
public class UpdateMerchantByIdRequest {
  ...
  public UpdateMerchantByIdRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public UpdateMerchantByIdRequest developerFeeRate(String developerFeeRate) {
  ...
  **/
   ...
   * @return the UpdateMerchantByIdRequest instance itself
   */
  public UpdateMerchantByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateMerchantByIdRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMerchantByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMerchantByIdRequest is not found in the empty JSON string", UpdateMerchantByIdRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMerchantByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMerchantByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMerchantByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMerchantByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMerchantByIdRequest>() {
           @Override
           public void write(JsonWriter out, UpdateMerchantByIdRequest value) throws IOException {
           ...
           @Override
           public UpdateMerchantByIdRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateMerchantByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateMerchantByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateMerchantByIdRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateMerchantByIdRequest
  */
  public static UpdateMerchantByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMerchantByIdRequest.class);
  }

 /**
  * Convert an instance of UpdateMerchantByIdRequest to an JSON string
  *
  * @return JSON string
  */
