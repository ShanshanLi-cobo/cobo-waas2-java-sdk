...
public class TransactionFILFee {
  ...
  public TransactionFILFee gasBase(String gasBase) {
  ...
  **/
  ...
  public TransactionFILFee gasPremium(String gasPremium) {
  ...
  **/
  ...
  public TransactionFILFee gasFeeCap(String gasFeeCap) {
  ...
  **/
  ...
  public TransactionFILFee gasLimit(String gasLimit) {
  ...
  **/
  ...
  public TransactionFILFee feeType(FeeType feeType) {
  ...
  **/
  ...
  public TransactionFILFee tokenId(String tokenId) {
  ...
  **/
  ...
  public TransactionFILFee feeUsed(String feeUsed) {
  ...
  **/
  ...
  public TransactionFILFee estimatedFeeUsed(String estimatedFeeUsed) {
  ...
  **/
   ...
   * @return the TransactionFILFee instance itself
   */
  public TransactionFILFee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionFILFee transactionFILFee = (TransactionFILFee) o;
    return Objects.equals(this.gasBase, transactionFILFee.gasBase) &&
        Objects.equals(this.gasPremium, transactionFILFee.gasPremium) &&
        Objects.equals(this.gasFeeCap, transactionFILFee.gasFeeCap) &&
        Objects.equals(this.gasLimit, transactionFILFee.gasLimit) &&
  ...
  public String toString() {
    ...
    sb.append("class TransactionFILFee {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionFILFee
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionFILFee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionFILFee is not found in the empty JSON string", TransactionFILFee.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionFILFee.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionFILFee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionFILFee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionFILFee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionFILFee.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionFILFee>() {
           @Override
           public void write(JsonWriter out, TransactionFILFee value) throws IOException {
           ...
           @Override
           public TransactionFILFee read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TransactionFILFee instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionFILFee given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionFILFee
  * @throws IOException if the JSON string is invalid with respect to TransactionFILFee
  */
  public static TransactionFILFee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionFILFee.class);
  }

 /**
  * Convert an instance of TransactionFILFee to an JSON string
  *
  * @return JSON string
  */
