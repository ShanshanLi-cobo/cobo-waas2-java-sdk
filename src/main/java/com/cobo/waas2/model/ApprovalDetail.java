...
public class ApprovalDetail {
  ...
  public ApprovalDetail transactionId(UUID transactionId) {
  ...
  **/
  ...
  public ApprovalDetail coboId(String coboId) {
    this.coboId = coboId;
    return this;
  }
  ...
  **/
  ...
  public ApprovalDetail requestId(String requestId) {
  ...
  **/
   ...
   * @return the ApprovalDetail instance itself
   */
  public ApprovalDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalDetail approvalDetail = (ApprovalDetail) o;
  ...
  public String toString() {
    ...
    sb.append("class ApprovalDetail {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApprovalDetail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalDetail is not found in the empty JSON string", ApprovalDetail.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalDetail>() {
           @Override
           public void write(JsonWriter out, ApprovalDetail value) throws IOException {
           ...
           @Override
           public ApprovalDetail read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ApprovalDetail instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApprovalDetail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApprovalDetail
  * @throws IOException if the JSON string is invalid with respect to ApprovalDetail
  */
  public static ApprovalDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalDetail.class);
  }

 /**
  * Convert an instance of ApprovalDetail to an JSON string
  *
  * @return JSON string
  */
