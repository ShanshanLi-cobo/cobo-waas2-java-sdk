...
public class EstimatedEvmEip1559FeeSlow {
  ...
  public EstimatedEvmEip1559FeeSlow maxFeePerGas(String maxFeePerGas) {
  ...
  **/
  ...
  public EstimatedEvmEip1559FeeSlow maxPriorityFeePerGas(String maxPriorityFeePerGas) {
  ...
  **/
  ...
  public EstimatedEvmEip1559FeeSlow gasLimit(String gasLimit) {
  ...
  **/
   ...
   * @return the EstimatedEvmEip1559FeeSlow instance itself
   */
  public EstimatedEvmEip1559FeeSlow putAdditionalProperty(String key, Object value) {
  ...
  public String toString() {
    ...
    sb.append("class EstimatedEvmEip1559FeeSlow {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EstimatedEvmEip1559FeeSlow
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EstimatedEvmEip1559FeeSlow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EstimatedEvmEip1559FeeSlow is not found in the empty JSON string", EstimatedEvmEip1559FeeSlow.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EstimatedEvmEip1559FeeSlow.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EstimatedEvmEip1559FeeSlow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EstimatedEvmEip1559FeeSlow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EstimatedEvmEip1559FeeSlow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EstimatedEvmEip1559FeeSlow.class));

       return (TypeAdapter<T>) new TypeAdapter<EstimatedEvmEip1559FeeSlow>() {
           @Override
           public void write(JsonWriter out, EstimatedEvmEip1559FeeSlow value) throws IOException {
           ...
           @Override
           public EstimatedEvmEip1559FeeSlow read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EstimatedEvmEip1559FeeSlow instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EstimatedEvmEip1559FeeSlow given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimatedEvmEip1559FeeSlow
  * @throws IOException if the JSON string is invalid with respect to EstimatedEvmEip1559FeeSlow
  */
  public static EstimatedEvmEip1559FeeSlow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimatedEvmEip1559FeeSlow.class);
  }

 /**
  * Convert an instance of EstimatedEvmEip1559FeeSlow to an JSON string
  *
  * @return JSON string
  */
