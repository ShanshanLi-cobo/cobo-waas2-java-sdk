...
public class TokenizationUpdateAllowlistAddressesRequest {
  ...
  public TokenizationUpdateAllowlistAddressesRequest action(TokenizationUpdateAddressAction action) {
    this.action = action;
    return this;
  }
  ...
  **/
  ...
  public TokenizationUpdateAllowlistAddressesRequest source(TokenizationTokenOperationSource source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  public TokenizationUpdateAllowlistAddressesRequest addresses(List<TokenizationUpdateAllowlistAddressesParamsAddressesInner> addresses) {
    this.addresses = addresses;
    return this;
  }

  public TokenizationUpdateAllowlistAddressesRequest addAddressesItem(TokenizationUpdateAllowlistAddressesParamsAddressesInner addressesItem) {
  ...
  **/
  ...
  public TokenizationUpdateAllowlistAddressesRequest appInitiator(String appInitiator) {
  ...
  **/
  ...
  public TokenizationUpdateAllowlistAddressesRequest fee(TransactionRequestFee fee) {
    this.fee = fee;
    return this;
  }
  ...
  **/
   ...
   * @return the TokenizationUpdateAllowlistAddressesRequest instance itself
   */
  public TokenizationUpdateAllowlistAddressesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TokenizationUpdateAllowlistAddressesRequest tokenizationUpdateAllowlistAddressesRequest = (TokenizationUpdateAllowlistAddressesRequest) o;
    return Objects.equals(this.action, tokenizationUpdateAllowlistAddressesRequest.action) &&
  ...
  public String toString() {
    ...
    sb.append("class TokenizationUpdateAllowlistAddressesRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TokenizationUpdateAllowlistAddressesRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenizationUpdateAllowlistAddressesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenizationUpdateAllowlistAddressesRequest is not found in the empty JSON string", TokenizationUpdateAllowlistAddressesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TokenizationUpdateAllowlistAddressesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenizationUpdateAllowlistAddressesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenizationUpdateAllowlistAddressesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenizationUpdateAllowlistAddressesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenizationUpdateAllowlistAddressesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenizationUpdateAllowlistAddressesRequest>() {
           @Override
           public void write(JsonWriter out, TokenizationUpdateAllowlistAddressesRequest value) throws IOException {
           ...
           @Override
           public TokenizationUpdateAllowlistAddressesRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TokenizationUpdateAllowlistAddressesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TokenizationUpdateAllowlistAddressesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TokenizationUpdateAllowlistAddressesRequest
  * @throws IOException if the JSON string is invalid with respect to TokenizationUpdateAllowlistAddressesRequest
  */
  public static TokenizationUpdateAllowlistAddressesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenizationUpdateAllowlistAddressesRequest.class);
  }

 /**
  * Convert an instance of TokenizationUpdateAllowlistAddressesRequest to an JSON string
  *
  * @return JSON string
  */
